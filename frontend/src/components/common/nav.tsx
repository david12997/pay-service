...
import MenuMobileIndex from "../sections/index.menu.mobile/menu.mobile";
...
const Navbar = ():JSX.Element => {
  ...
  return<>
      <MenuMobileIndex  menuMobile={menu} setMenuMobile={setMenu}/>
      <div className=" w-[92vw] ml-[4vw] flex justify-between  h-[70px] z-[99] fixed">
        ...
        <div className="hidden md:flex container-buttons w-[100%] md:w-[500px] justify-end p-2 text-[18px] ">
              <button onClick={()=>router('/ingresar')} className="ml-2 mr-2 w-[150px] bg-[#0087A8] rounded-[9px] text-white">
                  <p>
                      Ingresar
                  </p>
              </button>

              <button onClick={()=>router('/registrarse')} className="ml-2 mr-2 w-[150px] bg-[#2E28B7] rounded-[9px] text-white">
                  <p>
                      Empieza gratis
                  </p>
              </button>
        ...
        <div onClick={()=>setMenu(!menu)} className="hamburguer-menu flex md:hidden items-center">
